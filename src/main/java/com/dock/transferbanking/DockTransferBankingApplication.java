...
public class DockTransferBankingApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(DockTransferBankingApplication.class);
		app.run();
	}
